        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="detalles" placeholder="Detalles">{{ $producto->detalles }}</textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Precio:</strong>
                    <input type="number" min="0" step="0.01" name="precio" value="{{ $producto->precio }}" class="form-control" placeholder="0.00">
                </div>
            </div>
